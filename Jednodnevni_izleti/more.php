...
<head>
	<meta charset="UTF8"> 
	<title><?php echo $lang['More']; ?></title>
		...
		<article class="column column-9">
				<div class="column column-12">
					<div class="tekst column column-8">
						<h2><?php echo $lang['More']; ?></h2>
						<p><?php echo $lang['More_opis']; ?></p>
					</div>
					<div class="slika column column-4">
						<img src="img/more2.jpg" width="100%" height="25%">
						<img src="img/more1.jpg" width="100%" height="25%">
					</div>
				</div>
				...
				<div class="column column-12">
					...
					<?php
						...
						$queryPonuda = "SELECT Ponuda.Id, Ponuda.Naziv, Ponuda.Slika FROM Ponuda WHERE VrstaId=3";
