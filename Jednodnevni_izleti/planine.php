...
<head>
	<meta charset="UTF8"> 
	<title><?php echo $lang['Planine']; ?></title>
		...
		<article class="column column-9">
				<div class="column column-12">
					<div class="tekst column column-8">
						<h2><?php echo $lang['Planine']; ?></h2>
						<p><?php echo $lang['Planine_opis']; ?></p>
					</div>
					<div class="slika column column-4">
						<img src="img/planine1.jpg" width="100%" height="25%">
						<img src="img/planine2.jpg" width="100%" height="25%">
					</div>
				</div>
				...
				<div class="column column-12">
					...
					<?php
						...
						$queryPonuda = "SELECT Ponuda.Id, Ponuda.Naziv, Ponuda.Slika FROM Ponuda WHERE VrstaId=4";
